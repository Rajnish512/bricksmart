                        ...
                        <div class="col">
                            <div class="header-main">
                                ...
                                <div class="header-element logo">
                                    <a href="{{url('/')}}/">
                                        <img src="{{url('/')}}/public/logo/Bricksmart.png" alt="logo-image" class="img-fluid" style="height: ;">
                                    </a>
                                </div>
                                <!-- logo end -->
                                <!-- search start -->
          ...
          <!--</div>-->
           <div class="">
              <div class="">
                         ...
                         <div class="">
                         <div class="">
                         <a class="btn btn-style1" href="{{url('/')}}/register">Register</a>
                     <a class="btn btn-style1" href="{{url('/')}}/login">Log in</a>
                                                    </div>
