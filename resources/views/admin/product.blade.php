...
@if ($errors->any())
          ...
          <div class="col-11">
            ...
            <td><a class="btn btn-warning" href="{{url('admin/product-edit',$product->id)}}">
                          <i class="fa fa-edit text-white"></i>
                      </a>
                      
                      <a class="btn btn-danger" href="{{url('/')}}/admin/product/delete/{{$product->id}}" >
              ...
              <form action="{{url('/')}}/admin/product" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" name="mrp" placeholder="Enter MRP price">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" name="price" placeholder="Enter sale Price">
                  </div>
