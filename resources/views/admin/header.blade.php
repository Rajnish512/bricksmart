...
<head>
  ...
  <title>Bricks Mart | Dashboard</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
       ...
       @auth
      <li class="nav-item">
        <a class="nav-link btn btn-outline-secondary" data-widget="fullscreen" href="{{ route('logout.perform') }}" role="button">
         Logout</a>
      </li>
      @endauth
    </ul>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('/')}}/admin/productrequest" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                product Request
                <!--<span class="right badge badge-danger">New</span>-->
          ...
          <li class="nav-item">
            <a href="{{url('/')}}/admin/billing" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Billing Details
                <!--<span class="right badge badge-danger">New</span>-->
          ...
          <li class="nav-item">
            <a href="{{url('/')}}/admin/requirement" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
             Requirement
                <!--<span class="right badge badge-danger">New</span>-->
          ...
          <li class="nav-item">
            <a href="{{url('/')}}/admin/custom" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
             Home Construction Request
                <!--<span class="right badge badge-danger">New</span>-->
              </p>
            </a>
          </li>
          ...
          <!--  <ul class="nav nav-treeview">-->
          <!--    <li class="nav-item">-->
          <!--      <a href="{{url('/')}}/admin/simple" class="nav-link">-->
          <!--        <i class="far fa-circle nav-icon"></i>-->
          <!--        <p>Simple Tables</p>-->
          <!--      </a>-->
          <!--    </li>-->
          ...
          <!--    </li>-->
          <!--    <li class="nav-item">-->
          <!--      <a href="{{url('/')}}/admin/jsgrid" class="nav-link">-->
          <!--        <i class="far fa-circle nav-icon"></i>-->
          <!--        <p>jsGrid</p>-->
          <!--      </a>-->
          <!--    </li>-->
