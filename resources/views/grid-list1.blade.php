            ...
            <div class="row">
                        ...
                        <div class="price-filter">
                            ...
                            <ul class="all-price collapse" id="price-filter">
                                ...
                                <a href="{{url('/')}}/grid-list/"><li class="f-price">
                                    <!--<input type="checkbox">-->
                                    <!--<label>0-1000</label>-->
                                    <a href="{{url('/')}}/grid-list1/price/{{$id}}/0/1000">0-1000 <span class="grid-items"></span></a>
                                </li>
                                </a>
                                ...
                                <li class="f-price">
                                    ...
                                    <a href="{{url('/')}}/grid-list1/price/{{$id}}/1000/10000">1000-10000<span class="grid-items"></span></a>
                                </li>
                                <li class="f-price">
                                    <!--<input type="checkbox">-->
                                    <!--<label>200-300</label>-->
                                    <a href="{{url('/')}}/grid-list1/price/{{$id}}/10000/50000">10000-50000<span class="grid-items"></span></a>
                                </li>
                                <li class="f-price">
                                    <!--<input type="checkbox">-->
                                    <!--<label>200-300</label>-->
                                    <a href="{{url('/')}}/grid-list1/price/{{$id}}/50000/100000">50000-100000<span class="grid-items"></span></a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-9 col-md-8 col-12">
                    ...
                    <div class="grid-list-area">
                        <form action="{{url('/')}}/grid-list1" id="target" method="post">
