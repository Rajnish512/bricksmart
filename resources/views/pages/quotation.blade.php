                    ...
                    <div class="col">
                        <div class="about-l">
                            <ul class="about-link">
                                ...
                                <li class="about-p"><span class="text-light">Quotation</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
">
    <div class="container ">
                <div class="row ">
                    <div class="col">
                        <div class="checkout-area justify-content-center mt-4 mb-4">
                            <div class="billing-area bg-light">
                                <h2 style="
                                        background: #f5ab1e;
                                        text-align: center;
                                    ...
                                    <div class="billing-form">
                                        <ul class="billing-ul input-2">
                                            <li class="billing-li">
                                                ...
                                                <input type="text" name="pname" value="{{old('name')}}" placeholder="Product name">
                                        ...
                                        <ul class="billing-ul input-2">
                                            <li class="billing-li">
                                                <label>UOM</label>
                                                <input type="text" name="uom" placeholder="Enter unit of measurement">
                                            </li>
                                             <li class="billing-li">
                                                <label>Min.Qty</label>
                                                <input type="text" name="min" placeholder="Minimum quantity">
                                            </li>
                                        </ul>
...
<option value="Zimbabwe">Zimbabwe</option>
                                        ...
                                        <ul class="billing-ul input-2 mb-4">
                                            <li class="billing-li">
                                                <label>Email address</label>
                                                <input type="text" name="email" value="{{old('name')}}" placeholder="Email address">
                                                                                              <span class=text-danger>
                                                    @error('email')
                                                    {{$message}}
                                            ...
                                            <li class="billing-li">
                                                <label>Phone</label>
                                                <input type="text" name="phone" value="{{old('name')}}" placeholder="Phone">
                                                                                                <span class=text-danger>
                                                    @error('phone')
                                                    {{$message}}
                                         ...
                                         <h4 class="m-2">Please describe your requirements:</h4>
                                        <ul class="shipping-form">
                                       
                                            <li class="comment-area">
                                              
                                                <textarea name="discription" style             ="
                                                    width: 100% !important;
                                                    min-width: 100%;
                                                    height: 100px;
                                                "></textarea>
