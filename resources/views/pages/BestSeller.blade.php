                    ...
                    <div class="col">
                        <div class="about-l">
                            <ul class="about-link">
                                ...
                                <li class="about-p"><span class="text-light">Best Seller</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="price-filter">
                            ...
                            <ul class="all-price collapse" id="price-filter">
                                ...
                                <a href="{{url('/')}}/grid-list/"><li class="f-price">
                                    <!--<input type="checkbox">-->
                                    <!--<label>0-1000</label>-->
                                    <a href="{{url('/')}}/grid-list/price /0/1000">0-1000 <span class="grid-items"></span></a>
                                </li>
                                </a>
                                ...
                                <li class="f-price">
                                    ...
                                    <a href="{{url('/')}}/grid-list/price /1000/10000">1000-10000<span class="grid-items"></span></a>
                                </li>
                                <li class="f-price">
                                    <!--<input type="checkbox">-->
                                    <!--<label>200-300</label>-->
                                    <a href="{{url('/')}}/grid-list/price /10000/50000">10000-50000<span class="grid-items"></span></a>
                                </li>
                                <li class="f-price">
                                    <!--<input type="checkbox">-->
                                    <!--<label>200-300</label>-->
                                    <a href="{{url('/')}}/grid-list/price /50000/100000">50000-100000<span class="grid-items"></span></a>
                                </li>
                            </ul>
                        </div>
