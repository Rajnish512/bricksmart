                            ...
                            <div class="wishlist-all-pro">
                                <div class="wishlist-pro">
                                    <div class="wishlist-pro-image">
                                        <a href="product.html"><img src="{{url('/')}}/public/image/cart-page/cart-1/image1.jpg" class="img-fluid" alt="image"></a>
                                    </div>
                    ...
                    <div class="wishlist-area">
                        <div class="wishlist-details">
                            <div class="wishlist-all-pro">
                                <div class="wishlist-pro">
                                    <div class="wishlist-pro-image">
                                        <a href="product.html"><img src="{{url('/')}}/public/image/cart-page/cart-1/image3.jpg" class="img-fluid" alt="image"></a>
                                    </div>
                                    <div class="pro-details">
                    ...
                    <div class="wishlist-area">
                        <div class="wishlist-details">
                            <div class="wishlist-all-pro">
                                <div class="wishlist-pro">
                                    <div class="wishlist-pro-image">
                                        <a href="product.html"><img src="{{url('/')}}/public/image/cart-page/cart-1/image2.jpg" class="img-fluid" alt="image"></a>
                                    </div>
                                    <div class="pro-details">
                                        <h4><a href="product.html">Fresh green orange</a></h4>
                                        <span class="all-size">Size: <span class="pro-size">3kg</span></span>
                                        <span class="wishlist-text">Vegina-store</span>
                                    </div>
                                </div>
                                <div class="qty-item">
                                    <a href="cart.html" class="add-wishlist">Add to cart</a>
                            ...
                            <div class="other-link">
                                <ul class="c-link">
                                    <li class="wishlist-other-link"><a href="{{url('/')}}/grid-list">Continue shopping</a></li>
                                    <li class="wishlist-other-link"><a href="index1.html">Clear wishlist</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
