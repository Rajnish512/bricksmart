                    ...
                    <div class="col">
                        <div class="about-l">
                            <ul class="about-link">
                                ...
                                <li class="about-p"><span class="text-light">Contact Us</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="contact-info">
                                    <div class="contact-details">
                                        ...
                                        <form method="post">
                                            ...
                                            <label>Message</label>
                                            <textarea rows="5" name="message" placeholder="Your message hare..."></textarea>
                                            <button  type="submit" class="btn-style1">Submit <i class="ti-arrow-right"></i></button>
                                        </form>
                                    ...
                                    <div class="information">
                                        ...
                                        <div class="contact-in">
                                            <ul class="info-details">
                                                ...
                                                <li>
                                                    <h4>Address</h4>
                                                    <p>13 floor, Skyline plaza 3, Golf City, Lucknow, Uttar Pradesh 226030</p>
                                                </li>
                                            </ul>
                                            <ul class="info-details">
