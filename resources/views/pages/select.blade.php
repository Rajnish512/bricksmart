                    ...
                    <div class="col">
                        <div class="about-l">
                            <ul class="about-link">
                                ...
                                <li class="about-p"><span class="text-light">Select Product</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
Select Product Category</span>
    ...
    <!-- Order complete end -->
     <form action="{{ url('pages/select/') }}" method="post">
        @csrf
  ...
  <div class="row">
    ...
    <select class="form-control" name="Selectproduct" id="add_row" >
...
@section('script')
    ...
    headers: {
        ...
        for(var count1 = 0; count1 < data.product.length; count1++)
          ...
          html_code += '<td>'+data.product[count1].product_name+'<input type="hidden" name="products['+count+']" value="'+data.product[count1].product_name+'"></td>';
          html_code += '<td><input type="text" name="quantity['+count+']" value="'+data.product[count1].product_minimumorder+'" id="item_name'+count+'" /></td>';
